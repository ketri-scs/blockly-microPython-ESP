...
/**
 * @fileoverview Generating MicroPython for loop blocks.
...
Blockly.MicroPython['controls_for'] = function(block) {
  ...
  // Arguments are legal MicroPython code (numbers or strings returned by scrub()).
...
Blockly.MicroPython['controls_forEach'] = function(block) {
  // For each loop.
  var variable0 = Blockly.MicroPython.variableDB_.getName(
      block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
  var argument0 = Blockly.MicroPython.valueToCode(block, 'LIST',
      Blockly.MicroPython.ORDER_RELATIONAL) || '[]';
  var branch = Blockly.MicroPython.statementToCode(block, 'DO');
  branch = Blockly.MicroPython.addLoopTrap(branch, block.id) ||
      Blockly.MicroPython.PASS;
