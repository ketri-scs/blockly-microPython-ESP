...
/**
 * @fileoverview Generating MicroPython for math blocks.
...
Blockly.MicroPython['math_arithmetic'] = function(block) {
  ...
  // in MicroPython 2 and 3. However, is not an issue since Blockly does not
  ...
  switch (dropdown_property) {
    ...
    case 'DIVISIBLE_BY':
      var divisor = Blockly.MicroPython.valueToCode(block, 'DIVISOR',
          Blockly.MicroPython.ORDER_MULTIPLICATIVE);
      // If 'divisor' is some code that evals to 0, MicroPython will raise an error.
